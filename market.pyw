        ...
        try:
            if bas_gun == "": #tarih olmadığı durumda
                ...
                if firma == "TÜMÜ": #tüm firmlar için
                    ...
                    toplam_ciro = kasadan_alinan_toplam + kasadan_odeme_toplam + pos_gun_sonu_toplam - (pos_gun_sonu_toplam*float(self.pos_oranimiz)) + alinan_odeme_toplam
                    toplam_odeme = kasadan_odeme_toplam + kasadisi_odeme_toplam
                    kasa_brut = (toplam_ciro - toplam_odeme)
                    kasa_net = kasa_brut - gider_toplam
                    pos_kaybı = pos_gun_sonu_toplam*float(self.pos_oranimiz)
